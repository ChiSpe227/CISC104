...
public class PlaneTilter : MonoBehaviour
{
    ...
    private float minimumXTilt = 10 * Mathf.Deg2Rad;
    private float minimumZTilt = 10 * Mathf.Deg2Rad;
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.DownArrow))
        {
            ...
            if (gameObject.transform.rotation.x < minimumXTilt)
            {
                gameObject.transform.Rotate(-.1f, 0, 0);
            }
        }
        ...
        if (Input.GetKey(KeyCode.LeftArrow))
        {
            ...
            if (gameObject.transform.rotation.z > -minimumZTilt)
            {
